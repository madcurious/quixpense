...
+ (NSArray *)dummies
{
    return @[[[OldSPRCategory alloc] initWithName:@"Food and Drinks" colorNumber:@1],
             [[OldSPRCategory alloc] initWithName:@"Transportation" colorNumber:@20],
             [[OldSPRCategory alloc] initWithName:@"Health and Medical Expenses" colorNumber:@25],
             [[OldSPRCategory alloc] initWithName:@"Phone Bills" colorNumber:@14],
             [[OldSPRCategory alloc] initWithName:@"Miscellaneous Expenses" colorNumber:@35],
             [[OldSPRCategory alloc] initWithName:@"Blow-outs" colorNumber:@28]];
}
