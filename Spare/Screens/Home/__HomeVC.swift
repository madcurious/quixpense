...
class __HomeVC: MDStatefulViewController {
...
extension __HomeVC: UICollectionViewDataSource {
...
extension __HomeVC: UICollectionViewDelegateFlowLayout {
...
extension __HomeVC: UICollectionViewDelegate {
